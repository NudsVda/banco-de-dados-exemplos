...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `shoptop`.`view_pessoas` (`id` INT, `nome` INT, `data_cadastro` INT, `observacoes` INT, `cpf` INT, `razao_social` INT, `cnpj` INT);
...
START TRANSACTION;
USE `shoptop`;
INSERT INTO `shoptop`.`pessoa` (`id`, `nome`, `data_cadastro`, `observacoes`) VALUES (1, 'João das Cove', '2010-11-12 00:00:00', NULL);
INSERT INTO `shoptop`.`pessoa` (`id`, `nome`, `data_cadastro`, `observacoes`) VALUES (2, 'Vó do Badanha', '2011-11-12 03:00:00', NULL);
INSERT INTO `shoptop`.`pessoa` (`id`, `nome`, `data_cadastro`, `observacoes`) VALUES (3, 'Oficina Pai do Cirilo', '2015-12-30 00:20:00', NULL);
INSERT INTO `shoptop`.`pessoa` (`id`, `nome`, `data_cadastro`, `observacoes`) VALUES (4, 'Thomas Imports', '2017-01-23 01:11:22', NULL);
INSERT INTO `shoptop`.`pessoa` (`id`, `nome`, `data_cadastro`, `observacoes`) VALUES (5, 'Neymar Jr', '2008-02-28 14:55:00', NULL);
INSERT INTO `shoptop`.`pessoa` (`id`, `nome`, `data_cadastro`, `observacoes`) VALUES (6, 'Jonas Esticado', '2016-02-12 23:59:00', NULL);
